...
class EmailCoupon {
    ...
    private $template = "Templates/coupon";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$date,$reduction,$textReduction,$content,$content1,$content2,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.coupon',compact('date','content','content1','content2', 'reduction', 'textReduction'));
