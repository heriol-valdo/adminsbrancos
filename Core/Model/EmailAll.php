...
class EmailAll {
    ...
    function __construct($email,$subject,$receiverName,$head1,$head2,$title,$content,$lien,$lienTexte,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.email',compact('content', 'email','head1','head2','title','lien','lienTexte'));
