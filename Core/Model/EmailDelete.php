...
class EmailDelete {
    ...
    private $template = "Templates/delete";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$content,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.delete',compact('content'));
