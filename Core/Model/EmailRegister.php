...
class EmailRegister {
    ...
    private $template = "Templates/registration";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$content1,$content2,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.registration',compact('content1', 'email','content2'));
