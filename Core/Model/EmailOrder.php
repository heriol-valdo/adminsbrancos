...
class EmailOrder {
    ...
    private $template = "Templates/order";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$ref,$prix,$leNom,$numero,$adresse,$content1,$content2,$lien,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.order',compact('content1', 'content2', 'adresse','ref','prix','leNom','lien','numero'));
