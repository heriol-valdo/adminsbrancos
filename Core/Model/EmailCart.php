...
class EmailCart {
    ...
    private $template = "Templates/cart";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$content,$lien,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.cart',compact('content', 'email','lien'));
