...
class EmailShipped {
    ...
    private $template = "Templates/shipping";
    private $viewPath ="Views/";

    function __construct($email,$subject,$receiverName,$commande,$user,$content,$name="AFRIKFID",$username="noreply@afrikfid.boutique",$password="AFRIKFID00"){
        try{
            ...
            $template = $this->load('templates.shipping',compact('content', 'user', 'commande'));
