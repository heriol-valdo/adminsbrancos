...
App::setTitle("Les commandes de $profil->username");
App::setNavigation("Les commandes de $profil->username");
App::setBreadcumb('<li><a href="javascript:void(0);" onclick="history.go(-1);return false;">Clients</a></li><li class="active">Commandes</li>');
        ...
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Commandes de $profil->username <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('users/commandes?id='.$_GET['id']) ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('users/commandes') ?>" method="get">
                            ...
                            <table class="table table-striped">
                                ...
                                if(!empty($commandes)){
                                    foreach ($commandes as $commande) {
                                        $stat1 = $stat2 = $stat4 = $stat5 = $stat6 = $stat0 = $stat3 = $stat7 = $stat8 = $stat9 = "";
                                        ...
                                        if(Privilege::canView(Privilege::$eshopCommandValid,$user->privilege)){
                                            ...
                                            if($commande->transit_status =='Order is in Production'){
                                                $stat10 = '<li>
                                                        <a href="javascript:void(0);" data-id="'.$commande->id.'"data-delivery_date="'.$commande->delivery_date.'"
                                                        class="edit">Modifier la date de livraison</a>
                                                     </li>';
                                            }else{
                                                if(Privilege::canView(Privilege::$eshopCommandValid,$user->privilege)){
                                                    if($commande->transit_status !=='Order is Delivered'){
                                        ...
                                        echo
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-black">'.DateParser::DateShort($commande->date_delivery,1).'</td>
                                            </tr>
                                            ';
                                    }}else{
