...
App::setTitle("Historique d'abonnements aux cartes de fidelité de $profil->nom $profil->prenom");
App::setNavigation("Historique d'abonnements aux cartes de fidelité de $profil->nom $profil->prenom");
App::addScript('assets/js/history.js',true);
App::setBreadcumb('<li><a href="javascript:void(0);" onclick="history.go(-1);return false;">Clients</a></li><li class="active">Historique d\'abonnements aux cartes de fidelité</li>');
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Historique d'abonnements aux cartes de fidelité de $profil->nom $profil->prenom <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('users/cartes/history?id='.$_GET['id']) ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('users/cartes/history') ?>" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    <input type="text" class="form-control" <?= (isset($_GET['search'])&&!empty($_GET['search']))?'value="'.$_GET['search'].'"':''; ?>
                                           data-toggle="tooltip" data-original-title="Chercher par numéro de carte" name="search" placeholder="Chercher par numéro de carte">
                                </div>
                                <div class="col-md-3 form-group">
                                    ...
                                    foreach ($historis as $histori) {
                                        ...
                                        echo '<tr>
                                                ...
                                                <td class="text-center"><a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Detail de la carte"
                                                            class="detail text-info" data-url="'.App::url('cartes/detail').'" data-id="'.$histori->id.'"><i class="fa fa-info-circle fa-2x"></i></a> '.$state.'</td></tr>';
                                    }}else{
