...
App::setTitle("Les Conseils");
App::setNavigation("Les Conseils");
App::setBreadcumb('<li class="active">Conseils</li>');
        ...
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Conseils <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('councils') ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('councils') ?>" method="get">
                            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive project-stats">
                            <table class="table table-striped">
                                ...
                                <?php } } else{ ?>
                                    <tr>
                                        <td colspan="6" class="text-danger text-center">Liste des conseils vide...</td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                                <?php
