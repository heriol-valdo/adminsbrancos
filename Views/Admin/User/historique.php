...
App::setTitle("Historique des comptes virtuels");
App::setNavigation("Historique des comptes virtuels");
App::setBreadcumb('<li class="active">Historique des comptes virtuels</li>');
        ...
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Historique des comptes virtuels <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('transactions') ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('transactions') ?>" method="get">
                            <div class="row">
                            ...
                            <table class="table table-striped">
                                ...
                                if(!empty($historiques)){
                                    foreach ($historiques as $historique) {
                                        $client = Profil::find($historique->idUser);
                                        $etat = '<a><b>...</b></a>';
                                        ...
                                        echo
                                            ...
                                            <tr>
                                                ...
                                                <td class="">'.StringHelper::getShortName($client->nom,$client->prenom).'<br><small><b>'.$client->numero.'</b></small></td>
                                    ...
                                    echo '<tr><td colspan="8" class="text-danger text-center">Aucune transaction trouvée...</td></tr>';
                                }
                                ?>
                                </tbody>
                                <?php
