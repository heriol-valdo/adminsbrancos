...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= FileHelper::url('assets/img/logo2.svg') ?>" sizes="16x16">
    <link rel="icon" type="image/png" href="<?= FileHelper::url('assets/img/logo2.svg') ?>" sizes="32x32">
...
<body class="page-login login-alt">
    ...
    <main class="page-content" style="background-image: url(<?= FileHelper::url('assets/images/bg.jpg') ?>);background-repeat: no-repeat;background-position: center center;background-size: cover">
        <?php
